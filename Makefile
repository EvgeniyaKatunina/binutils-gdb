...
target_alias=arc-snps-linux-uclibc
target_vendor=snps
target_os=linux-uclibc
target=arc-snps-linux-uclibc

program_transform_name = s&^&arc-snps-linux-uclibc-&

prefix = /home/evgeniya/empty_dir
exec_prefix = ${prefix}
...
TOPLEVEL_CONFIGURE_ARGUMENTS=./configure --disable-sim --disable-binutils --disable-gas --disable-ld --target=arc-snps-linux-uclibc --prefix=/home/evgeniya/empty_dir

tooldir = ${exec_prefix}/arc-snps-linux-uclibc
build_tooldir = ${exec_prefix}/arc-snps-linux-uclibc
...
BUILD_CONFIGARGS =  --cache-file=./config.cache '--disable-sim' '--disable-binutils' '--disable-gas' '--disable-ld' '--prefix=/home/evgeniya/empty_dir' --program-transform-name='s&^&arc-snps-linux-uclibc-&' --disable-option-checking --with-build-subdir="$(BUILD_SUBDIR)"
...
SUBDIRS =  intl libiberty opcodes bfd readline zlib libdecnumber gdb gprof etc
TARGET_CONFIGDIRS = 
# This is set by the configure script to the arguments to use when configuring
# directories built for the host system.
HOST_CONFIGARGS =  --cache-file=./config.cache  '--disable-sim' '--disable-binutils' '--disable-gas' '--disable-ld' '--prefix=/home/evgeniya/empty_dir' --program-transform-name='s&^&arc-snps-linux-uclibc-&' --disable-option-checking
...
TARGET_SUBDIR = arc-snps-linux-uclibc
# This is set by the configure script to the arguments to use when configuring
# directories built for the target.
TARGET_CONFIGARGS = --cache-file=./config.cache --enable-multilib --with-cross-host=x86_64-unknown-linux-gnu   '--disable-sim' '--disable-binutils' '--disable-gas' '--disable-ld' '--prefix=/home/evgeniya/empty_dir' --program-transform-name='s&^&arc-snps-linux-uclibc-&' --disable-option-checking --with-target-subdir="$(TARGET_SUBDIR)"
# This is the list of variables to export in the environment when
...
AR_FOR_TARGET=arc-snps-linux-uclibc-ar
AS_FOR_TARGET=arc-snps-linux-uclibc-as
CC_FOR_TARGET=$(STAGE_CC_WRAPPER) arc-snps-linux-uclibc-gcc

# If GCC_FOR_TARGET is not overriden on the command line, then this
# variable is passed down to the gcc Makefile, where it is used to
# build libgcc2.a.  We define it here so that it can itself be
# overridden on the command line.
GCC_FOR_TARGET=$(STAGE_CC_WRAPPER) arc-snps-linux-uclibc-gcc
CXX_FOR_TARGET=$(STAGE_CC_WRAPPER) arc-snps-linux-uclibc-c++
RAW_CXX_FOR_TARGET=$(STAGE_CC_WRAPPER) arc-snps-linux-uclibc-c++
GCJ_FOR_TARGET=$(STAGE_CC_WRAPPER) arc-snps-linux-uclibc-gcj
GFORTRAN_FOR_TARGET=$(STAGE_CC_WRAPPER) arc-snps-linux-uclibc-gfortran
GOC_FOR_TARGET=$(STAGE_CC_WRAPPER) arc-snps-linux-uclibc-gccgo
DLLTOOL_FOR_TARGET=arc-snps-linux-uclibc-dlltool
LD_FOR_TARGET=arc-snps-linux-uclibc-ld

LIPO_FOR_TARGET=arc-snps-linux-uclibc-lipo
NM_FOR_TARGET=arc-snps-linux-uclibc-nm
OBJDUMP_FOR_TARGET=arc-snps-linux-uclibc-objdump
OBJCOPY_FOR_TARGET=arc-snps-linux-uclibc-objcopy
RANLIB_FOR_TARGET=arc-snps-linux-uclibc-ranlib
READELF_FOR_TARGET=arc-snps-linux-uclibc-readelf
STRIP_FOR_TARGET=arc-snps-linux-uclibc-strip
WINDRES_FOR_TARGET=arc-snps-linux-uclibc-windres
WINDMC_FOR_TARGET=arc-snps-linux-uclibc-windmc
